      ...
      <section className="property">
        ...
        <div className="property__container container">
          <div className="property__wrapper">
            ...
            {<Features
              entire={offer.propFeatures.entire}
              bedroom={offer.propFeatures.bedroom}
              adults={offer.propFeatures.adults}
            />}
            ...
            <div className="property__inside">
              ...
              <ul className="property__inside-list">
                {offer.insideItems.map((item, index) => <InsideItem key={index} item={item}/>)}
              </ul>
            </div>
